<?php
/**
 * FileControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of File Module
 *
 * @category Test
 * @package File
...
namespace OnePlaceTest\File\Controller;

use OnePlace\File\Controller\FileController;
