...
use OnePlace\File\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/file/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('file-api');
    }
}
