 ...
 *
 * Module Class File for File Module
 *
 * @category Config
 * @package File
        ...
        return [
            'factories' => [
                ...
                Controller\FileController::class => function($container) {
                    ...
                    $tableGateway = $container->get(Model\FileTable::class);
